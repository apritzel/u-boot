...
#if defined(CONFIG_MACH_SUN50I) || defined(CONFIG_SUN50I_H6_GEN)
	calibrate = true;
#endif
...
#elif defined(CONFIG_SUN50I_H6_GEN)
...
#if defined(CONFIG_MACH_SUN50I) || defined(CONFIG_MACH_SUN8I) || defined(CONFIG_SUN50I_H6_GEN)
	if (sdc_no == 2)
...
#if !defined(CONFIG_SUN50I_H6_GEN)
