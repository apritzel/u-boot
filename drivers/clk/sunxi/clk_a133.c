...
static struct ccu_clk_gate a133_gates[] = {
...
static struct ccu_reset a133_resets[] = {
...
const struct ccu_desc a133_ccu_desc = {
	.gates = a133_gates,
	.resets = a133_resets,
	.num_gates = ARRAY_SIZE(a133_gates),
	.num_resets = ARRAY_SIZE(a133_resets),
};
