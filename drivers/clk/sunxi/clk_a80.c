...
static const struct ccu_clk_gate a80_gates[] = {
	[CLK_SPI0]		= GATE(0x030, BIT(31)),
	[CLK_SPI1]		= GATE(0x034, BIT(31)),
	[CLK_SPI2]		= GATE(0x038, BIT(31)),
	[CLK_SPI3]		= GATE(0x03c, BIT(31)),

	[CLK_BUS_SPI0]		= GATE(0x180, BIT(20)),
	[CLK_BUS_SPI1]		= GATE(0x180, BIT(21)),
	[CLK_BUS_SPI2]		= GATE(0x180, BIT(22)),
	[CLK_BUS_SPI3]		= GATE(0x180, BIT(23)),
...
static const struct ccu_reset a80_resets[] = {
	[RST_BUS_SPI0]		= RESET(0x1a0, BIT(20)),
	[RST_BUS_SPI1]		= RESET(0x1a0, BIT(21)),
	[RST_BUS_SPI2]		= RESET(0x1a0, BIT(22)),
	[RST_BUS_SPI3]		= RESET(0x1a0, BIT(23)),
